// La variable historique ressemblera à ça :
...
// ]
// On observe ci-haut dans cette exemple que l'utilisateur à joué deux fois et on voit la date avec les réponses
//que l'utilisateur à choisi.
...
function recupererHistorique() {
    ...
    let historiqueChaine = localStorage.getItem("super-quiz-historiques");
...
function commencerLeQuiz() {
    ...
    historique.push(
        {
            ...
            // date: new Date().toLocaleDateString('fr-CA', {month: }), 
    ...
    //SERA UNE QUESTION POSÉE DANS QUIZ VENDREDI PROCHAIN
